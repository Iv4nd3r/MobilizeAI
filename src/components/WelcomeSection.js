...
import CarImage from '../assets/car-illustration.svg';
import Logo from '../assets/mobilizeai-logo.svg'; // Import the logo 
  ...
  return (
    <section className="bg-customDark text-white py-60 relative">
      <div className="flex flex-col lg:flex-row items-center justify-center max-w-screen-lg mx-auto px-4">
        {/* Text Section */}
        <div className="lg:w-3/5 text-center lg:text-left mb-10 lg:mb-0 lg:pr-10 relative z-10"> {/* Adjusted width */}
          <h1
          ...
          <img src={Logo} alt="MobilizeAI Logo" className="w-[200px] lg:w-[800px] inline-block align-middle" /> {/* Adjust width as needed */}
          <div className="flex items-start mt-4">
            ...
            >
              <p className="text-[18px] lg:text-[22px] font-extrabold text-offWhite font-nunito">
                MobilizeAI empowers businesses to cut emissions with real-time weather insights, AI-driven energy-saving
                tips, and smart tracking for sustainable, efficient operations.
              </p>
            </div>
        ...
        <div className="lg:w-1/2 flex justify-center lg:justify-end relative">
          <img src={CarImage} alt="Car illustration" className="w-[350px] lg:w-[500px] h-auto absolute top-0 lg:top-[30%] right-0 transform translate-y-[-50%]" />
        </div>
      </div>
    </section>
  );
