...
import { Button, buttonVariants } from '@/Legacy component/components/ui/button'
import {
  IconGitHub,
  IconNextChat,
  IconSeparator,
  IconVercel
} from '@/Legacy component/components/ui/icons'
import { UserMenu } from '@/Legacy component/components/user-menu'
    ...
    <header className="sticky top-0 z-50 flex items-center justify-between w-full h-16 px-4 shrink-0 bg-gradient-to-b from-background/10 via-background/50 to-background/80 backdrop-blur-xl">
      ...
      <div className="flex items-center justify-end gap-2">
        <Button asChild size="sm" variant="ghost">
          <a
            target="_blank"
            href="https://github.com/Iv4nd3r/AIWeather"
